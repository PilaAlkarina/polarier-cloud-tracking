    ...
    return (
        <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
            ...
            <div className="space-y-3 text-xs">
                ...
                <div className="flex items-center gap-3">
                    <span className="inline-flex items-center justify-center w-8 h-8 bg-purple-100 border-2 border-purple-300 rounded-full text-purple-600 shrink-0 font-bold">
                        ✓✓
                    </span>
                    <span className="text-gray-700 font-medium">Segunda Revisión</span>
                </div>
            </div>
        </div>
    );
