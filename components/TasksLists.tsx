                            ...
                            <div key={usuario} className="space-y-1">
                                ...
                                <div className="space-y-0.5">
                                    {futurasPorUsuario[usuario].map((pantalla) => (
                                        <div
                                            key={pantalla.id}
                                            className="text-xs bg-green-50 rounded px-2 py-0.5 flex items-center justify-between"
                                        >
                                            <span className="truncate flex-1 text-gray-700">{pantalla.nombre}</span>
                            ...
                            <div key={usuario} className="space-y-1">
                                ...
                                <div className="space-y-0.5">
                                    {completadasPorUsuario[usuario].map((pantalla) => (
                                        <div
                                            key={pantalla.id}
                                            className="text-xs bg-emerald-50 rounded px-2 py-0.5 flex items-center justify-between"
                                        >
                                            <span className="truncate flex-1 text-gray-700">{pantalla.nombre}</span>
