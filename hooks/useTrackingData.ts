...
export function useTrackingData() {
    ...
    const [nextResetTime, setNextResetTime] = useState<number>(60 * 1000); // 1 minuto en ms
    ...
    // Auto-reset cada 1 minuto
    useEffect(() => {
        const RESET_INTERVAL = 60 * 1000; // 1 minuto
